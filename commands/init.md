...
- `formal` — academic tone, passive voice, specialized terminology
- `simple` — clear and straightforward, active voice, plain language
- `concise` — brief and to the point, minimal words, results-focused
